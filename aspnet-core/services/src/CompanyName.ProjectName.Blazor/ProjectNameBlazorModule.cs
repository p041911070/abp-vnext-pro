...
using App = Volo.Abp.AspNetCore.Components.Web.BasicTheme.Themes.Basic.App;
...
namespace CompanyName.ProjectName.Blazor
{
    ...
    public class ProjectNameBlazorModule : AbpModule
    {
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            ConfigureAntDesign(context, builder);
        }
        ...
        private void ConfigureRouter(ServiceConfigurationContext context)
        {
            ...
            {
                options.AppAssembly = typeof(ProjectNameBlazorModule).Assembly;
            });
        }
        ...
        private static void ConfigureAuthentication(WebAssemblyHostBuilder builder)
        {
            builder.Services.AddOidcAuthentication(options =>
            {
                ...
                options.ProviderOptions.DefaultScopes.Add("ProjectName");
        ...
        private void ConfigureAutoMapper(ServiceConfigurationContext context)
        {
            ...
            {
                options.AddMaps<ProjectNameBlazorModule>();
            });
        }
    }
}
